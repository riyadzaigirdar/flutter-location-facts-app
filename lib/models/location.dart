...
class Location{
  ...
  static Location fetchDetail(int locationId){
    List<Location> locations = Location.fetchAll().toList();
  ...
  static List<Location> fetchAll(){
    return [
      Location(1, 'Kiyomizu-dera riyad 1', 'assets/images/main2.jpg', [
      ...
      Location(2, 'Mount Fuji riyad 2', 'assets/images/main.jpg', [
        LocationFact('Summary',
      ...
      Location(3, 'Arashiyama Bamboo Grove riyad 3', 'assets/images/main3.jpg', [
        LocationFact('Summary',
